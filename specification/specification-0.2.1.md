...
> **Legacy reference:** this Markdown document describes the historical A2A `0.2.1`
> wire format and is retained only for migration comparison. The normative baseline for
> new code is the checked-in A2A `1.0` Proto at [`a2a.proto`](./a2a.proto), pinned by
> [`a2a-1.0.0.lock`](./a2a-1.0.0.lock).
