...
| Concurrency | 8 |
| Gateway sequential p95/p99 | 4311ms / 6649ms |
| Gateway concurrent p95/p99 | 4232ms / 4233ms |
| Direct upstream p95/p99 | 4182ms / 4249ms |
| Gateway overhead (sequential p95) | 129ms (local loopback estimate) |
