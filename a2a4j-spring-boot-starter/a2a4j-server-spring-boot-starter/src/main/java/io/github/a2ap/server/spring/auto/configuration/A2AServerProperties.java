...
public class A2AServerProperties implements Serializable {
    ...
    /**
     * Protocol bindings advertised for {@link #url}. Applications must list only
     * bindings that their HTTP endpoint actually implements.
     */
    private List<String> protocolBindings = List.of("JSONRPC", "HTTP+JSON");
    ...
    public void setProtocolBindings(List<String> protocolBindings) {
        this.protocolBindings = protocolBindings == null ? new ArrayList<>() : new ArrayList<>(protocolBindings);
    }
