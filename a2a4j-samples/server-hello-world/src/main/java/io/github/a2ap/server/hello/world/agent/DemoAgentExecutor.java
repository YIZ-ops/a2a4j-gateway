 ...
 * a {@code SendMessage} or {@code SendStreamingMessage} request to the A2A server. It
...
public class DemoAgentExecutor implements AgentExecutor {
     ...
     * {@code CancelTask} JSON-RPC method. In this demo implementation, it simply logs
