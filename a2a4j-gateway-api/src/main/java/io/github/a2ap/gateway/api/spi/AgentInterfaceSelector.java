...
/** Selects one supported A2A interface for a chosen Agent instance. */
public interface AgentInterfaceSelector {

    /** Selects an interface compatible with inbound protocol and command semantics. */
    Mono<AgentInterface> choose(AgentInstance instance, ProtocolDescriptor inbound,
