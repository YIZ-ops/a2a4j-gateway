...
public class AgentCard {
    ...
    /** A2A 1.0 protocol interfaces advertised by this agent. */
    private List<Map<String, String>> supportedInterfaces;
    ...
    public List<Map<String, String>> getSupportedInterfaces() {
        return supportedInterfaces;
    }

    public void setSupportedInterfaces(List<Map<String, String>> supportedInterfaces) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, url, supportedInterfaces, provider, version, documentationUrl, capabilities,
    ...
    public String toString() {
        return "AgentCard{" + "id='" + id + '\'' + ", name='" + name + '\'' + ", description='" + description + '\'' +
                ", url='" + url + '\'' + ", supportedInterfaces=" + supportedInterfaces + ", provider=" + provider + ", version='" + version + '\'' +
    ...
    public static class Builder {
        ...
        public Builder supportedInterfaces(List<Map<String, String>> supportedInterfaces) {
            this.supportedInterfaces = supportedInterfaces;
            return this;
        }
        ...
        public AgentCard build() {
            AgentCard card = new AgentCard(id, name, description, url, provider, version, documentationUrl, capabilities,
                    authentication, securitySchemes, security, defaultInputModes, defaultOutputModes, skills,
                    supportsAuthenticatedExtendedCard);
            card.setSupportedInterfaces(supportedInterfaces);
            return card;
        }
