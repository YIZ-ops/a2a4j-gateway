...
public interface A2AClient {
     ...
     *
     * @param params The parameters for the GetTask method.
     ...
     *
     * @param params The parameters for the CancelTask method.
     ...
     *
     * @param params The parameters for the CreateTaskPushNotificationConfig method.
     ...
     *
     * @param params The parameters for the GetTaskPushNotificationConfig method.
